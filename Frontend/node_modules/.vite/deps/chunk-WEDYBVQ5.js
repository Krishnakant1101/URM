...
function deepClone(source) {
  if (React15.isValidElement(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React15.isValidElement(source[key])) {
...
function resolveProps2(defaultProps, props) {
...
true ? StyledEngineProvider.propTypes = {
   ...
   */
  injectFirst: import_prop_types9.default.bool
} : void 0;
...
true ? GlobalStyles.propTypes = {
  ...
  styles: import_prop_types10.default.oneOfType([import_prop_types10.default.array, import_prop_types10.default.string, import_prop_types10.default.object, import_prop_types10.default.func])
} : void 0;
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React29.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React31.forwardRef(function Box3(inProps, ref) {
    ...
    const muiStyledResolver = (styleArg, ...expressions) => {
      ...
      if (true) {
        ...
        if (displayName === void 0) {
          displayName = `Styled(${getDisplayName2(tag)})`;
        }
...
var ThemeContext2 = React33.createContext(null);
if (true) {
...
function useTheme3() {
  const theme = React34.useContext(ThemeContext_default);
  if (true) {
...
var RtlContext = React36.createContext();
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => {
    ...
    if (!value) {
      throw new Error(true ? `MUI: \`useColorScheme\` must be called under <CssVarsProvider />` : formatMuiErrorMessage2(19));
    }
    return value;
  };
  function CssVarsProvider(props) {
    ...
    Object.entries(colorSchemes).forEach(([key, scheme]) => {
      ...
      theme.vars = deepmerge2(theme.vars, vars);
    ...
    theme.vars = deepmerge2(theme.vars, rootVars);
    React41.useEffect(() => {
    ...
    const element = (0, import_jsx_runtime11.jsxs)(React41.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime11.jsxs)(React41.Fragment, {
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    attribute: import_prop_types17.default.string,
    /**
     * The component tree.
     */
     ...
     */
    colorSchemeSelector: import_prop_types17.default.string,
    /**
     ...
     */
    defaultColorScheme: import_prop_types17.default.oneOfType([import_prop_types17.default.string, import_prop_types17.default.object]),
    /**
...
function prepareCssVars(theme, parserConfig) {
  ...
  Object.entries(otherColorSchemes || {}).forEach(([key, scheme]) => {
    ...
    themeVars = deepmerge2(themeVars, varsWithDefaults);
    colorSchemesMap[key] = {
      css: css2,
      vars
    };
  ...
  const Grid2 = React43.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime13.jsx)(GridRoot, _extends({
      ...
      children: React43.Children.map(children, (child) => {
        if (React43.isValidElement(child) && isMuiElement2(child, ["Grid"])) {
...
var generateUtilityClass3 = (componentName, slot) => generateUtilityClass2(componentName, slot, "Mui");
var generateUtilityClasses3 = (componentName, slots) => generateUtilityClasses2(componentName, slots, "Mui");
...
function extendTheme(themeOptions) {
  ...
  const _ref2 = scalesInput ? deepmerge2(defaultScales, scalesInput) : defaultScales, {
    colorSchemes
...
var ClassNameConfiguratorContext = React45.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass4) {
  ...
  } = React45.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React46.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React46.useEffect(() => {
  ...
  const updateRootElementName = React46.useCallback((instance) => {
...
var _excluded14 = ["className", "elementType", "ownerState", "externalForwardedProps", "getSlotOwnerState", "internalForwardedProps"];
...
function useSlot(name, parameters) {
  ...
  } = parameters, useSlotPropsParams = _objectWithoutPropertiesLoose(parameters, _excluded14);
  const {
  ...
  const ref = useForkRef2(internalRef, resolvedComponentsProps == null ? void 0 : resolvedComponentsProps.ref, parameters.ref);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WEDYBVQ5.js.map
