...
var Popover = React17.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(RootSlot, {
    ...rootProps,
    ...
    ...other,
    ref,
    children: (0, import_jsx_runtime14.jsx)(TransitionComponent, {
      appear: true,
      in: open,
      onEntering: handleEntering,
      onExited: handleExited,
      ...
      ...TransitionProps,
      children: (0, import_jsx_runtime14.jsx)(PaperSlot, {
        ...paperProps,
        ref: handlePaperRef,
        children
      })
...
var Menu = React18.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(MenuRoot, {
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime15.jsx)(MenuMenuList, {
...
var NativeSelectInput = React19.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime16.jsxs)(React19.Fragment, {
    children: [(0, import_jsx_runtime16.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime16.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React20.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React20.Fragment, {
    children: [(0, import_jsx_runtime17.jsx)(SelectSelect, {
      as: "div",
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span3 || (_span3 = (0, import_jsx_runtime17.jsx)("span", {
          className: "notranslate",
          "aria-hidden": true,
          children: "​"
        }))
      ) : display
    }), (0, import_jsx_runtime17.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime17.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime17.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
var TextField = React23.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime20.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime20.jsxs)(TextFieldRoot, {
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    ownerState,
    ...other,
    children: [label != null && label !== "" && (0, import_jsx_runtime20.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime20.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children
    }) : InputElement, helperText && (0, import_jsx_runtime20.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
//# sourceMappingURL=chunk-JYULZVRN.js.map
